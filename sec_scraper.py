                    ...
                    for row in main_table[0].find_all("tr"):
                        ...
                        if len(cols) != 0:
                            ...
                            if filing_number_path != None:
                                Filing_Number_Link = (
                                    sec_base_url + filing_number_path["href"]
                                )
                            else:
                                break
                            ...
                            document_link_path = cols[1].find(
                                "a", {"href": True, "id": "documentsbutton"}
                            )
                            if document_link_path != None:
                                Document_Link = (
                                    sec_base_url + document_link_path["href"]
                                )
                            else:
                                Document_Link = None
    ...
    def html_table_extractor(self, report_url):
        ...
        if table:
            try:
                ...
                self.df_xml = (
                    self.df_xml.replace({r"\$": ""}, regex=True)
                        ...
                        while row.table_name not in [
                            ...
                            try:
                                ...
                                for item in df_table.iloc[:, 0]:
                                    match = re.search(r"\D{3}. \d{2}, \d{4}", item)
